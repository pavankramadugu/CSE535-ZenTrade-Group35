...
import com.asu.mc.zentrade.fuzzy.fuzzyEvaluate
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        riskRadioGroup.setOnCheckedChangeListener { _, checkedId ->
            ...
            if (selectedRadioButton != null) {
                ...
                val portfolioFactor = fuz.fuzzy((selectedRadioButton.text.toString()), Random.nextInt(50,120), Random.nextInt(10,20))
                personalInfo?.appetite = portfolioFactor
            }
        }
